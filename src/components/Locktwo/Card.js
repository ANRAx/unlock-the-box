        ...
        return (
            <div>
                ...
                <div className="whole-card">
                    ...
                    <div>
                        <span className="bg-yellow dib br3 pa3 ma2 grow bw4 shadow-5">{this.state.positions.posOne}</span>
                        <span className="bg-yellow dib br3 pa3 ma2 grow bw4 shadow-5">{this.state.positions.posTwo}</span>
                        <span className="bg-yellow dib br3 pa3 ma2 grow bw4 shadow-5">{this.state.positions.posThree}</span>
                        <span className="bg-yellow dib br3 pa3 ma2 grow bw4 shadow-5">{this.state.positions.posFour}</span>
                    </div>
                    <br />
                    ...
                    <div>
                        <button className="bg-yellow dib br3 pa3 ma2 bw1 shadow-5 spin-button" variant="secondary" type="submit" onClick={this.checkAnswer}>Unlock</button>
                    </div>
                </div>
            </div>
        );
